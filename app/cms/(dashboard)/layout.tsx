    ...
    <div className="min-h-screen bg-white">
      <div className="mx-auto flex min-h-screen max-w-[1680px] shadow-sm shadow-gcs-border/30">
        ...
        <div className="flex min-h-screen min-w-0 flex-1 flex-col bg-white md:rounded-l-none">
          <header className="sticky top-0 z-10 border-b border-gcs-border/80 bg-white/95 px-4 py-6 pl-[4.5rem] backdrop-blur-md md:pl-10 md:pt-8">
            <div className="flex flex-col gap-1 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <h1 className="mt-1 text-xl font-semibold tracking-tight text-gcs-foreground md:text-2xl">Content administration</h1>
          ...
          <div className="flex-1 bg-slate-50/60 px-4 py-8 md:px-10 md:py-10">
