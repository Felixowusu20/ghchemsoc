    ...
    <div className="mx-auto max-w-4xl space-y-10">
      <div>
        ...
        <p className="mt-2 text-sm text-slate-600">
          Slug becomes <code className="rounded bg-slate-100 px-1.5 py-0.5 text-xs">/news/[slug]</code>. Click Edit to
          update an article.
        </p>
      </div>
      ...
      <CmsCard className="p-8">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <CmsSectionTitle>{editingId ? "Edit article" : "Add article"}</CmsSectionTitle>
          {editingId ? (
        ...
        <form className="mt-8 grid gap-5 md:grid-cols-2" onSubmit={save}>
          ...
          <div className="md:col-span-2">
            <CmsButton type="submit">{editingId ? "Save changes" : "Create"}</CmsButton>
          </div>
        </form>
      </CmsCard>
